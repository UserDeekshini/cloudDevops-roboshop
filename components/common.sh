...
CONFIG_SERVICE(){
    ...
    sed -i -e 's/REDIS_ENDPOINT/redis.rhobode.iternal/' /home/roboshop/$COMPONENT/systemd.service
    sed -i -e 's/MONGO_ENDPOINT/mongodb.rhobode.iternal/' /home/roboshop/$COMPONENT/systemd.service 
